...
def main():
    ...
    # Task 1
    # List all the bodies, joints, and actuators in the environment
    ...
    # List of joint names
    print("Total DoFs (nv):", env.sim.model.nv)

    # the number of DOF
    print("Body DoFs:", env.sim.model.body_dofnum)

    # List of Operations in actuators
    print("Number of actuators (nu):", env.sim.model.nu)
